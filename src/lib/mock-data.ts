...
export const portfolioData: Portfolio = {
  ...
  skills: [
    ...
    },
    {
      ...
      name: 'UI / Design',
      icon: '✦',
      skills: ['Storybook', 'TailwindCSS', 'SCSS', 'Framer Motion', 'Chromatic', 'Figma Dev Tools'],
    },
    {
      id: 'dev-tools',
      name: 'Dev Tools',
      icon: '◈',
      skills: ['Git', 'Docker', 'Vercel', 'Vite', 'Prettier', 'Cursor', 'VSCode'],
    },
    {
      id: 'ui-libs',
      name: 'Librairies UI',
      icon: '◉',
      skills: ['Bootstrap', 'Material UI', 'Element UI', 'Shadcn/ui', 'Ant Design'],
    },
    {
      id: 'tests',
      name: 'Tests',
      icon: '◎',
      skills: ['Vitest', 'Jest', 'Playwright', 'Testing Library'],
    },
    {
      id: 'backend-bdd',
      name: 'Backend / BDD',
      icon: '◫',
      skills: ['Supabase', 'PostgreSQL', 'MongoDB', 'Compass', 'Prisma'],
    },
    {
      id: 'apis',
      name: 'APIs',
      icon: '⬡',
      skills: ['OpenAI', 'Stripe', 'JWT'],
    },
  ],
  projects: [
    {
