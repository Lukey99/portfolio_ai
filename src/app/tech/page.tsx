...
const TestsDashboardSection = dynamic(
  () =>
    import('@/components/sections/TestsDashboardSection').then(m => ({
      default: m.TestsDashboardSection,
    })),
...
export const metadata = {
  ...
  description:
    'Stack technique, workflow IA, tests automatisés, API REST, architecture atomique et Storybook.',
};
  ...
  <div style={{ padding: '0 1.5rem' }}>
    <div
      style={{
        height: '1px',
        background:
          'linear-gradient(90deg, transparent, rgba(var(--overlay-rgb), 0.18), transparent)',
        maxWidth: '72rem',
        margin: '0 auto',
      }}
    />
