...
export function ScoreRing({ score, color, size = 120, stroke = 10 }: { score: number; color: string; size?: number; stroke?: number }) {
...
export function CoverageBar({ label, pct, color, delay }: { label: string; pct: number; color: string; delay: number }) {
...
export function SubScoreCard({ q, parentInView, index }: { q: QualityMerged; parentInView: boolean; index: number }) {
...
export function StatHeroCard({ stat, inView, index }: { stat: StatHeroCardData; inView: boolean; index: number }) {
...
export function MobileSubScoreRow({ q, inView, index }: { q: QualityMerged; inView: boolean; index: number }) {
