    ...
    <div ref={ref} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
      {isMobile ? (
        <div style={{ ...CARD, padding: '1.1rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
            <div style={{ position: 'relative', flexShrink: 0 }}>
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: '0.65rem', fontWeight: 900, color: gradeColor }}>
                    {grade}
                  </div>
                </motion.div>
              </div>
            ...
            <div>
              ...
              >
                ...
                >
                  <span style={{ fontSize: '0.58rem', fontWeight: 900, color: gradeColor }}>
                    {grade}
                  </span>
                </div>
          ...
          <div
            style={{ borderTop: '1px solid rgba(var(--overlay-rgb), 0.07)', paddingTop: '0.65rem' }}
          >
            {quality.map((q, i) => (
              <MobileSubScoreRow key={q.label} q={q} inView={inView} index={i} />
            ))}
          </div>
        </div>
      ) : (
        ...
        >
          ...
          >
            {quality.map((q, i) => (
              <SubScoreCard key={q.label} q={q} parentInView={inView} index={i} />
            ))}
          </div>
        </div>
      )}
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    background: isOpen ? mix(imp.color, 5) : 'transparent',
                    border: `1px solid ${isOpen ? mix(imp.color, 19) : 'rgba(var(--overlay-rgb), 0.07)'}`,
                    borderRadius: '0.6rem',
                    cursor: 'pointer',
                    textAlign: 'left',
                    transition: 'all 0.2s',
                    ...
                    >
                      <div
                        style={{
                          ...
                          lineHeight: 1.6,
                          borderLeft: `2px solid ${mix(imp.color, 19)}`,
                          marginLeft: '0.85rem',
                          marginTop: '0.25rem',
                        }}
                      >
