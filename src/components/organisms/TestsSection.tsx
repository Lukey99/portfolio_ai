...
const UNIT_SUITES = [
  ...
  {
    category: 'Molecule',
    file: 'ExperienceCard.test.tsx',
    path: 'src/components/molecules/',
    colorVar: 'var(--violet-mid)',
    bg: 'rgba(167,139,250,0.10)',
    border: 'rgba(167,139,250,0.22)',
    tests: [
      "affiche société, poste et période",
      "badge CDI pour type full-time",
      "badge Alternance pour apprenticeship",
      "badge Projet pour entrepreneur",
      "affiche tous les points de description",
    ],
  },
  {
    category: 'Molecule',
